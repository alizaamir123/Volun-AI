...
import { n as require_react_is$2, t as clsx } from "./clsx-Ce6rdqMl.js";
...
function deepClone(source) {
	if (/* @__PURE__ */ import_react$9.isValidElement(source) || !isPlainObject(source)) return source;
	const output = {};
...
function deepmerge(target, source, options = { clone: true }) {
	...
	if (isPlainObject(target) && isPlainObject(source)) Object.keys(source).forEach((key) => {
		if (/* @__PURE__ */ import_react$9.isValidElement(source[key])) output[key] = source[key];
...
var init_getDisplayName$1 = __esmMin((() => {
	import_react_is = require_react_is$2();
...
var import_react$8 = /* @__PURE__ */ __toESM(require_react());
var PropsContext = /* @__PURE__ */ import_react$8.createContext(void 0);
function DefaultPropsProvider$1({ value, children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)(PropsContext.Provider, {
		value,
		children
	});
}
DefaultPropsProvider$1.propTypes = {
	...
	* @ignore
	*/
	value: import_prop_types$4.default.object
};
...
function useDefaultProps$1({ props, name }) {
	return getThemeProps({
		props,
		name,
		theme: { components: import_react$8.useContext(PropsContext) }
	});
}
//#endregion
...
function DefaultPropsProvider(props) {
	return /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)(DefaultPropsProvider$1, _extends({}, props));
}
DefaultPropsProvider.propTypes = {
	...
	* @ignore
	*/
	value: import_prop_types$4.default.object.isRequired
};
...
var import_react$7, syncFallback, useInsertionEffect, useInsertionEffectAlwaysWithSyncFallback, useInsertionEffectWithLayoutFallback;
var init_emotion_use_insertion_effect_with_fallbacks_browser_esm = __esmMin((() => {
	...
	useInsertionEffect = import_react$7.useInsertionEffect ? import_react$7.useInsertionEffect : false;
	useInsertionEffectAlwaysWithSyncFallback = useInsertionEffect || syncFallback;
	useInsertionEffectWithLayoutFallback = useInsertionEffect || import_react$7.useLayoutEffect;
})), import_react$5, import_react$6, isBrowser, EmotionCacheContext, CacheProvider, withEmotionCache, ThemeContext, hasOwn, typePropName, createEmotionProps, Insertion$1, Emotion$1;
var init_emotion_element_d59e098f_esm = __esmMin((() => {
	...
	EmotionCacheContext = /* @__PURE__ */ import_react$5.createContext(typeof HTMLElement !== "undefined" ? /* @__PURE__ */ createCache({ key: "css" }) : null);
	CacheProvider = EmotionCacheContext.Provider;
	withEmotionCache = function withEmotionCache(func) {
		return /* @__PURE__ */ (0, import_react$6.forwardRef)(function(props, ref) {
			return func(props, (0, import_react$6.useContext)(EmotionCacheContext), ref);
		});
	};
	if (!isBrowser) withEmotionCache = function withEmotionCache(func) {
		return function(props) {
			var cache = (0, import_react$6.useContext)(EmotionCacheContext);
			if (cache === null) {
				cache = createCache({ key: "css" });
				return /* @__PURE__ */ import_react$5.createElement(EmotionCacheContext.Provider, { value: cache }, func(props, cache));
			} else return func(props, cache);
		};
	};
	ThemeContext = /* @__PURE__ */ import_react$5.createContext({});
	...
	Insertion$1 = function Insertion(_ref) {
		...
		if (!isBrowser && rules !== void 0) {
			...
			return /* @__PURE__ */ import_react$5.createElement("style", (_ref2 = {}, _ref2["data-emotion"] = cache.key + " " + serializedNames, _ref2.dangerouslySetInnerHTML = { __html: rules }, _ref2.nonce = cache.sheet.nonce, _ref2));
		}
		return null;
	};
	Emotion$1 = /* @__PURE__ */ withEmotionCache(function(props, cache, ref) {
		...
		var serialized = serializeStyles(registeredStyles, void 0, import_react$5.useContext(ThemeContext));
		...
		return /* @__PURE__ */ import_react$5.createElement(import_react$5.Fragment, null, /* @__PURE__ */ import_react$5.createElement(Insertion$1, {
			cache,
			serialized,
			isStringTag: typeof WrappedComponent === "string"
		}), /* @__PURE__ */ import_react$5.createElement(WrappedComponent, newProps));
	});
}));
//#endregion
//#region node_modules/@emotion/react/dist/emotion-react.esm.js
function css() {
...
var import_react$4, jsx, Global;
var init_emotion_react_esm = __esmMin((() => {
	...
	jsx = function jsx(type, props) {
		var args = arguments;
		if (props == null || !hasOwn.call(props, "css")) return import_react$4.createElement.apply(void 0, args);
		var argsLength = args.length;
		var createElementArgArray = new Array(argsLength);
		createElementArgArray[0] = Emotion$1;
		createElementArgArray[1] = createEmotionProps(type, props);
		for (var i = 2; i < argsLength; i++) createElementArgArray[i] = args[i];
		return import_react$4.createElement.apply(null, createElementArgArray);
	};
	(function(_jsx) {
		var JSX;
	...
	Global = /* @__PURE__ */ withEmotionCache(function(props, cache) {
		...
		var serialized = serializeStyles([styles], void 0, import_react$4.useContext(ThemeContext));
		if (!isBrowser) {
			var _ref;
			var serializedNames = serialized.name;
			...
			return /* @__PURE__ */ import_react$4.createElement("style", (_ref = {}, _ref["data-emotion"] = cache.key + "-global " + serializedNames, _ref.dangerouslySetInnerHTML = { __html: rules }, _ref.nonce = cache.sheet.nonce, _ref));
		}
		var sheetRef = import_react$4.useRef();
...
var import_react$3, isDevelopment, testOmitPropsOnStringTag, testOmitPropsOnComponent, getDefaultShouldForwardProp, composeShouldForwardProps, ILLEGAL_ESCAPE_SEQUENCE_ERROR, Insertion, createStyled$1;
		...
		return function() {
			...
			var Styled = withEmotionCache(function(props, cache, ref) {
				...
				if (props.theme == null) {
					...
					mergedProps.theme = import_react$3.useContext(ThemeContext);
				}
				...
				newProps.className = className;
				if (ref) newProps.ref = ref;
				return /* @__PURE__ */ import_react$3.createElement(import_react$3.Fragment, null, /* @__PURE__ */ import_react$3.createElement(Insertion, {
					cache,
					serialized,
					isStringTag: typeof FinalTag === "string"
				}), /* @__PURE__ */ import_react$3.createElement(FinalTag, newProps));
			});
...
function StyledEngineProvider(props) {
	...
	const cache = import_react$1.useMemo(() => {
	...
	if (injectFirst || enableCssLayer) return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(CacheProvider, {
		value: cache,
		children
	});
	return children;
}
var import_react$1, import_prop_types$3, import_jsx_runtime$1, cacheMap;
var init_StyledEngineProvider$1 = __esmMin((() => {
	...
	StyledEngineProvider.propTypes = {
		...
		*/
		enableCssLayer: import_prop_types$3.default.bool,
		/**
		* By default, the styles are injected last in the <head> element of the page.
		* As a result, they gain more specificity than any other style sheet.
		* If you want to override MUI's styles, set this prop.
		*/
		injectFirst: import_prop_types$3.default.bool
	};
}));
//#endregion
...
var import_prop_types$2, import_jsx_runtime;
var init_GlobalStyles$1 = __esmMin((() => {
	...
	GlobalStyles.propTypes = {
		defaultTheme: import_prop_types$2.default.object,
		styles: import_prop_types$2.default.oneOfType([
...
var import_prop_types$1, responsivePropType;
var init_responsivePropType = __esmMin((() => {
	import_prop_types$1 = /* @__PURE__ */ __toESM(require_prop_types());
	responsivePropType = import_prop_types$1.default.oneOfType([
...
var SvgIcon = /* @__PURE__ */ import_react$8.forwardRef(function SvgIcon(inProps, ref) {
	...
	const hasSvgAsChild = /* @__PURE__ */ import_react$8.isValidElement(children) && children.type === "svg";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)(SvgIconRoot, _extends({
		...
		ownerState,
		children: [hasSvgAsChild ? children.props.children : children, titleAccess ? /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("title", { children: titleAccess }) : null]
	}));
});
SvgIcon.propTypes = {
	/**
	...
	* @default 'inherit'
	*/
	color: import_prop_types$4.default.oneOfType([import_prop_types$4.default.oneOf([
		"inherit",
		"action",
		"disabled",
		"primary",
	...
	* @default 'medium'
	*/
	fontSize: import_prop_types$4.default.oneOfType([import_prop_types$4.default.oneOf([
		"inherit",
		"large",
		"medium",
		"small"
	...
	*/
	htmlColor: import_prop_types$4.default.string,
	/**
	...
	* @default false
	*/
	inheritViewBox: import_prop_types$4.default.bool,
	/**
	* The shape-rendering attribute. The behavior of the different options is described on the
	* [MDN Web Docs](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/shape-rendering).
	* If you are having issues with blurry icons you should investigate this prop.
	*/
	shapeRendering: import_prop_types$4.default.string,
	/**
	...
	*/
	titleAccess: import_prop_types$4.default.string,
	/**
	...
	* @default '0 0 24 24'
	*/
	viewBox: import_prop_types$4.default.string
};
...
function createSvgIcon(path, displayName) {
	function Component(props, ref) {
		return /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)(SvgIcon, _extends({
	...
	return /* @__PURE__ */ import_react$8.memo(/* @__PURE__ */ import_react$8.forwardRef(Component));
}
//#endregion
export { GlobalStyles as $, defaultSxConfig as A, getPath as B, require_colorManipulator as C, isPlainObject as Ct, init_createTheme as D, extendSxProp as E, createSpacing as F, resolveBreakpointValues as G, handleBreakpoints as H, init_createSpacing as I, init_styled_engine as J, createBreakpoints as K, createUnarySpacing as L, init_palette as M, init_cssGrid as N, createTheme$1 as O, init_borders as P, styled_engine_exports as Q, getValue as R, common as S, deepmerge as St, init_styleFunctionSx as T, init_extends as Tt, init_breakpoints as U, init_style as V, mergeBreakpointsInOrder as W, internal_serializeStyles as X, internal_processStyles as Y, styled$1 as Z, blue as _, capitalize as _t, styled as a, DefaultPropsProvider$1 as at, purple as b, require_prop_types as bt, identifier_default as c, init_objectWithoutPropertiesLoose as ct, createTheme as d, generateUtilityClasses as dt, StyledEngineProvider as et, duration as f, generateUtilityClass as ft, lightBlue as g, init_capitalize as gt, green as h, resolveProps as ht, svgIconClasses as i, useDefaultProps as it, init_sizing as j, styleFunctionSx as k, defaultTheme as l, init_clamp as lt, createTypography as m, composeClasses as mt, SvgIcon as n, keyframes as nt, rootShouldForwardProp as o, capitalize_default as ot, easing as p, ClassNameGenerator as pt, init_createBreakpoints as q, getSvgIconUtilityClass as r, ThemeContext as rt, slotShouldForwardProp as s, _objectWithoutPropertiesLoose as st, createSvgIcon as t, css as tt, createMuiTheme as u, clamp as ut, orange as v, init_getDisplayName as vt, createMixins as w, _extends as wt, grey as x, init_deepmerge as xt, red as y, getDisplayName as yt, init_spacing as z };

//# sourceMappingURL=createSvgIcon-CAxZqae7.js.map